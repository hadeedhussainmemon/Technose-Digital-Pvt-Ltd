  ...
  return (
    <div className="border border-white/[0.2] flex flex-col items-start max-w-sm mx-auto p-4 relative h-[30rem]">
      ...
      <h2 className="text-black  mt-4 text-sm font-light">
        We blend bold visual identity with performance-minded execution to help
        brands stand out and scale.
      </h2>
      <p className="text-sm border font-light border-white/[0.2]  rounded-full mt-4  text-black px-2 py-0.5">
        Brand + Growth
      </p>
    </div>
  );
